        ...
        >
          <div className="chrome-ltr flex h-full flex-col">
            <div className="flex items-center justify-between px-6 py-5 sm:px-8">
              <MethodaLogo size={24} href="/" />
              <button
                type="button"
                onClick={onClose}
                aria-label={t("close")}
                className="flex h-10 w-10 items-center justify-center border border-border text-text"
              >
                ...
                return (
                  ...
                  >
                    <Link
                      href={href}
                      onClick={onClose}
                      className="text-content flex items-baseline gap-4 py-3"
                    >
                      ...
                      <span
                        className={
                          active
                            ? "text-3xl font-medium tracking-tight text-text"
                            : "text-3xl font-normal tracking-tight text-muted"
                        }
                      >
                        {t(key)}
                      </span>
            ...
            <div className="flex items-center justify-between border-t border-border px-6 py-8 sm:px-8">
              ...
              <Link
                href="/contact"
                onClick={onClose}
                className="label-mono text-accent-secondary"
              >
                {t("letsTalk")}
              </Link>
            </div>
